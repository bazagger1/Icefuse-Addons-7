...
File Path:   addons/[server]_undercover_cops/lua/fus/cl_menu.lua
...
function fus.menu()
      ...
      bg.title = 'Choose an undercover role, officer. There is a briefing period between assignments (5 minutes).'
